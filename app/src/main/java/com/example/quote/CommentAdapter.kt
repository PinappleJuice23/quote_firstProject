    ...
    override fun onBindViewHolder(holder: CommentViewHolder, position: Int) {
            ...
            .addOnSuccessListener { document ->
                if (document.exists()) {
                    if(document.data!!["like"].toString().toInt() == 1) {
                        likeImage.setImageResource(R.drawable.baseline_thumb_up_alt_24)
                    } else {
                        dislikeImage.setImageResource(R.drawable.baseline_thumb_down_alt_24)
                    }
        ...
        likeImage.setOnClickListener {
            ...
            db.collection("likes").document(user!!.uid + ":" + comments[position].commentId)
                ...
                .addOnSuccessListener {
                    likeImage.setImageResource(R.drawable.baseline_thumb_up_alt_24)
                    dislikeImage.setImageResource(R.drawable.baseline_thumb_down_off_alt_24)
                    db.collection("likes")
                        .whereEqualTo("commentId", comments[position].commentId)
                        .get()
                        .addOnSuccessListener { documents ->
        ...
        dislikeImage.setOnClickListener {
            ...
            db.collection("likes").document(user!!.uid + ":" + comments[position].commentId)
                .set(newLike)
                .addOnSuccessListener {
                    likeImage.setImageResource(R.drawable.baseline_thumb_up_off_alt_24)
                    dislikeImage.setImageResource(R.drawable.baseline_thumb_down_alt_24)
                    db.collection("likes")
                        .whereEqualTo("commentId", comments[position].commentId)
                        .get()
